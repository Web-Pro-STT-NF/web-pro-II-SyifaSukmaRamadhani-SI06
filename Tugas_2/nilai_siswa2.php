...
<body>
    <div class="content">
        <div class="container-fluid">
            ...
            <form class="form-horizontal" method="POST" action="nilai_siswa2.php" class="mt-5 pt-5">
...
<?php
    ...
    if(isset($proses)){
        ...
        switch(true){
            case ($nilai_A):
                echo "<br/>Pedikat : Sangat Memuaskan";
                break;
            case ($nilai_B):
                echo "<br/>Pedikat : Memuaskan";
                break;
            case ($nilai_C):
                echo "<br/>Pedikat : Cukup";
                break;
            case ($nilai_D):
                echo "<br/>Pedikat : Kurang";
                break;
            case ($nilai_E):
